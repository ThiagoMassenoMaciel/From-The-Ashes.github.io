class Tela1 extends Phaser.Scene{
  ...
  preload(){
    ...
    this.load.spritesheet("jogador", "../../assents/jogador.png", { frameWidth: 16, frameHeight: 16 });
    this.load.spritesheet("saida", "../../assents/saida.png", { frameWidth: 16, frameHeight: 16 });
    this.load.spritesheet("player", "../../assents/AchadoSaida-16px-16px-5-frames.png", { frameWidth: 16, frameHeight: 16 });
