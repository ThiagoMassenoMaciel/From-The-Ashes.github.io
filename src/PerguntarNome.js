...
*/
    ...
    const textEntry = this.add.text((config.width /6) - 5  , 420, '', { font: '62px Courier', fill: '#000000' }).setOrigin(0,0).setDepth(1);

    this.input.keyboard.on('keydown', event =>
    {
        this.TelaNome = this.add.image( (config.width /6) - 20  , 420, "TelaNome_escrevendo").setOrigin(0,0).setScale(1.2)// para fazer desaparecer o nome digite seu nome
